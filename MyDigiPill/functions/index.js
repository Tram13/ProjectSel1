...
//var serviceAccount = require("../mydigipill-firebase-adminsdk-lcyt9-4d79e23e1f.json");
...
/*
{
  ...
  databaseURL: "https://mydigipill.firebaseio.com"
}
*/
 ...
 */
exports.mintAdminToken = functions
    .region('europe-west3')
    .https
    .onCall((data, context) => {
  const uid = data.uid;
 ...
 */
exports.recursiveDelete = functions.region('europe-west3')
  .runWith({
    timeoutSeconds: 540,
    memory: '2GB'
  })
